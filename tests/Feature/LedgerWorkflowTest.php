...
class LedgerWorkflowTest extends TestCase
{
    ...
    public function test_a_sequence_of_deposits_buys_and_sells_computes_correct_balance_and_holdings(): void
    {
        ...
        $this->assertSame('1000.00', (string) $client->cash_balance->getAmount());

        // 2. buy 5 AAPL @ 100.00 -> balance 500.00, holdings AAPL 5
        $this->postJson("/api/clients/{$client->id}/transactions", [
            'type' => 'buy', 'instrument_id' => $aapl->id, 'quantity' => 5, 'price' => '100.00',
        ])->assertStatus(201);
        $this->assertSame('500.00', (string) $client->cash_balance->getAmount());
        $this->assertSame(5, $this->holdingQuantity($client, $aapl));
        ...
        $this->assertSame('0.00', (string) $client->cash_balance->getAmount());
        $this->assertSame(5, $this->holdingQuantity($client, $aapl));
        ...
        $this->assertSame('860.00', (string) $client->cash_balance->getAmount());
        $this->assertSame(2, $this->holdingQuantity($client, $aapl));
